    ...
    module System
      module OrganizationFormOverride
        ...
        included do
          ...
          attribute :maximum_minor_age, Integer, default: Decidim::Kids.maximum_minor_age.to_i
          ...
          validates :maximum_minor_age, numericality: { greater_than: 0 }, if: ->(form) { form.enable_minors_participation.present? }
          ...
          def minor_lower_than_adult
            return if minimum_minor_age.to_i <= maximum_minor_age.to_i
